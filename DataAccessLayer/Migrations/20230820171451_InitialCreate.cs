        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboudDetails2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorEmailConfirmed = table.Column<bool>(type: "bit", nullable: false),
                    AuthorLastLogin = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AuthorLastLoginIP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorBirthDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AuthorLanguages = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorContactEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorContactPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorStatus = table.Column<bool>(type: "bit", nullable: false),
                    AuthorFacebookProfile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorTwitterProfile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorLinkedInProfile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorCity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorNeighborhood = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorStreet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorZipCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonalWebsite = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorResume = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorRegistrationDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
